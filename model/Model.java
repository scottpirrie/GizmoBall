...
public class Model extends Observable {
	...
	public void moveBall(double move) {
		System.out.println("Move ball time: "+move);
		if (move > 0) {
	...
	private Ball movelBallForTime(Ball ball, double time) {
			System.out.println("Move ball for time: " + time);
			double newX = 0.0;
			double newY = 0.0;

			//gravity correct
			//ball.setVelo(ball.getVelo().plus(new Vect(0,9.81*time)));
			//needs friction formula
			//ball.setVelo(ball.getVelo().minus(new Vect(0,0.47)));
